...
enum textureFormat_t {
	...
	//------------------------
	// Half-float color (VIS: MilkDrop-style ping-pong feedback needs this --
	// repeated 8-bit re-quantization across many feedback generations bands
	// visibly; see plans/PRD-implementation-status.md M1 step 7)
	//------------------------

...
int idUserInterfaceManagerLocal::GetGuiCount() const {
	return guis.Num();
}

idUserInterface * idUserInterfaceManagerLocal::GetGui( int index ) const {
...
void idUserInterfaceManagerLocal::AddGui( idUserInterface *gui ) {
	if ( gui ) {
		guis.Append( static_cast<idUserInterfaceLocal *>( gui ) );
	}
}
